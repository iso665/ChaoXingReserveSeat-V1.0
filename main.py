...
def main(users, action=False):
    ...
    if action:
        ...
        logging.info("严格等待到北京时间10:09:00...")
        wait_until("10:09:00", action)
        logging.info("北京时间10:09:00 - 开始登录账号")
        ...
        logging.info("严格等待到北京时间10:10:00...")
        wait_until("10:10:00", action)
        logging.info("北京时间10:10:00 - 开始预约流程")
        attempt_times = 0
